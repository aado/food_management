...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:50px">
  ...
  <!-- About Section -->
  <div class="w3-container w3-padding-32 w3-center" style="background-image:  url('images/1.jpg'); height: 700px; background-position: center;
  background-repeat: no-repeat;
  background-size: cover" >  
    <div class="w3-padding-32" style="background-color:white;width: 520px;margin-top: 15%; margin-left: 25%;">
